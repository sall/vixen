...
namespace VixenModules.Output.CommandController
{
    public partial class SetupForm : Form
    {
        ...
        public SetupForm(Data data)
        {
            ...
            {
                cboMonitorList.Items.Add(screen.DeviceName);
            });

            this.txtPlaybackMonitor.Text = data.VideoPlaybackMonitor;
            this.chkRepeatPlayback.Checked = data.VideoPlaybackRepeat;
            this.chkPlaybackFullScreen.Checked = data.VideoShowFullScreen;
        ...
        private void txtPlaybackMonitor_TextChanged(object sender, EventArgs e)
        {
            RdsData.VideoPlaybackMonitor = txtPlaybackMonitor.Text;
        }

        private void btnChangeMonitor_Click(object sender, EventArgs e)
        {
            RdsData.VideoPlaybackMonitor = txtPlaybackMonitor.Text = cboMonitorList.SelectedItem.ToString();
        }

        private void btnGetMediaFileName_Click(object sender, EventArgs e)
        {
            ...
            {
                txtMediaFileNAme.Text = dlg.FileName;
            }
        }
        ...
        private void chkRepeatPlayback_CheckedChanged(object sender, EventArgs e)
        {
            RdsData.VideoPlaybackRepeat = chkRepeatPlayback.Checked;
        }
