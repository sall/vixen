...
using VixenApplication.Properties;
...
namespace VixenApplication
{
	public partial class VixenApplication : Form, IApplication
	{
		...
		protected override void OnClosed(EventArgs e)
		{
			...
			# region this code does *not* handle minimized/maximized window.
		...
		// Added region to handle closing when window is minimized or maximized.
